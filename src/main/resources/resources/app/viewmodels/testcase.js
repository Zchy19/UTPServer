	...
	function ($, komapping, system, app, lang, ko, blockUI, loginManager, projectManager,
		...
		function TestCaseViewModel() {
			...
			this.createScript = function (parentId) {
				...
				self.utpService.createTestcase(defNewscript,
			...
			this.initManager = function () {
				...
				webix.ready(function () {
					...
					self.projectManager.setScriptGroupManager($$("fm"));
					$$("fm").$$("files").define({
			...
			this.detached = function () {
				...
				self.sourceId = "";
				self.projectManager.backupScripts = self.projectManager.getScriptGroups();
			};
		};
