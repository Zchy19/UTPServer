define([], function() {
	function diffSequenceService() {
    const NOT_YET_SET = 0;

    function countCommonItemsF(aIndex, aEnd, bIndex, bEnd, isCommon){
      let nCommon = 0;
    ...
    function countCommonItemsR(aStart, aIndex, bStart, bIndex, isCommon){
      let nCommon = 0;
    ...
    function extendOverlappablePathsF(
      d,
      aStart,
      aEnd,
      bStart,
    ...
    function extendOverlappablePathsR(
      d,
      aStart,
      aEnd,
      bStart,
    ...
    function divide(
      ...
      throw new Error(
        `: no overlap aStart=${aStart} aEnd=${aEnd} bStart=${bStart} bEnd=${bEnd}`
      );
    }; // Given index intervals and input function to compare items at indexes,
    ...
    function validateLength(name, arg){
    ...
    function validateCallback(name, arg){
    ...
    this.diffSequence = function(aLength, bLength, isCommon, foundSubsequence) {
  ...
  return new diffSequenceService();
})