...
define(['jquery', 'knockout'], function ($, ko) {
    ...
    return {
         ...
         */
        get: function (url, timeout, query, headers) {
        	/* 1. $.get('/getdata?_=' + new Date().getTime())
        	   2. cache: false
        	*/
            return $.ajax(url, { cache: false,  timeout : timeout, data: query, headers: ko.toJS(headers) });
        },        
         ...
         * @return {Promise} A promise of the response data.
         */
        post: function (url, timeout, data, headers) {
            return $.ajax({
            	cache: false,
            	url: url,
            	timeout : timeout,
        ...
        filepost: function (url, timeout, data, headers) {
            return $.ajax({
            	cache: false,
            	url: url,
            	timeout : timeout,
